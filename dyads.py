...
## social condition
soc_syncNet = syncNet(name="social condition", file="data/socialtapping_V4-final.xlsx")

soc_syncNet.import_model()
soc_syncNet.build_dyad()
soc_syncNet.plug_parameters()
soc_syncNet.record_interaction(time=450, delta=0.1)
soc_syncNet.plot_activation()
soc_syncNet.plot_weights()
import ipdb; ipdb.set_trace()
## nonsocial condition
nonsoc_syncNet = syncNet(name="nonsocial condition", file="data/nonsocialtapping_V4-final.xlsx")
